  ...
  return (
    <footer className='text-white mp-20'>
      ...
      <div className='bg-[#1ADFA6]'>
                ...
                <div className='mb-10 flex flex-col gap-3 '>
                  {links.map((link, index) => (
                    <Link
                      key={link + index}
                      to='/'
                      className='text-black-300 text-sm hover:text-black '
                    >
                      {link}
                    </Link>
                  ))}
        ...
        <div className=''>
          <p className='container px-5 mx-auto text-black mt-2 '>
          ...
          <div className='container mx-auto px-5 pt-6 pb-8 flex flex-wrap items-center justify-between '>
            <div className='w-full md:w-2/4 lg:w-1/3 h-16 flex items-center justify-center md:justify-start '>
              <TextInput
                styles='text-blue-500 w-full flex-grow md:w-40 2xl:w-64 bg-gray-100 sm:mr-4 md-2'
                type='email'
              ...
              <CustomButton
                title='Subscribe 🔔'
                containerStyles={
                  "block bg-[red] text-white px-5 py-2.5 text-md rounded hover:bg-gray-500 focus:potline-none flex-col items-center mt-2"
                }
              />
            </div>
